...
public class BackgroundGeolocationPlugin extends CordovaPlugin implements PluginDelegate {
    ...
    private static final int BACKGROUND_LOCATION_PERMISSION_REQUEST_CODE = 1022;
    private static final int LOCATION_PERMISSION_REQUEST_CODE = 101;

    private void showExplanationDialog2() {
        new AlertDialog.Builder(getContext())
                .setTitle("Permission Required")
                .setMessage("To provide better services, we need access to your location at all times. Please allow 'Always' location access in the settings.")
    ...
    private void showLocationExplanationDialog() {
        ...
        cordova.getActivity().runOnUiThread(() -> {
            ...
            String title = isHungarian ? "Engedély szükséges" : "Permission Required";
            String message = isHungarian
                    ? "A szolgáltatás érdekében állandó helyhozzáférésre van szükségünk. Engedélyezze az 'Mindig' helyhozzáférést az Alkalmazásengedélyek/Helyadatok beállításokban."
                    : "To provide the service, we need access to your location at all times. Please allow 'Always' location access in the settings.";
    ...
    private void showBatteryExplanationDialog() {
        ...
        cordova.getActivity().runOnUiThread(() -> {
            ...
            String title = isHungarian ? "Beállítás szükséges" : "Setting Required";
            String message = isHungarian
                    ? "A szolgáltatás érdekében ki kell kapcsolni az akkumlátorkímélő beállítást. Kérlek válaszd ki a 'Nincs korlátozás' opciót!"
                    : "To ensure the service works properly, you need to disable the battery-saving settings. Please select the 'No restrictions' option!";
            String positiveButton = isHungarian ? "Ugrás a beállításokhoz" : "Go to Settings";
            String negativeButton = isHungarian ? "Mégsem" : "Cancel";
